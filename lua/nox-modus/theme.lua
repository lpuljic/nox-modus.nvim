...
theme.set_highlights = function()
	...
	hl(0, "NonText", { fg = c.gray2 }) -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
	...
	hl(0, "ColorColumn", { bg = c.dawn }) -- used for the columns set with 'colorcolumn'
	hl(0, "CursorColumn", { bg = c.gray1 }) -- Screen-column at the cursor, when 'cursorcolumn' is set.
	...
	hl(0, "MoreMsg", { fg = c.blue2 }) -- |more-prompt|
	hl(0, "Error", { fg = c.red, bold = true }) -- (preferred) any erroneous construct
	hl(0, "Visual", { fg = c.gray1, bg = c.gray3 }) -- Visual mode selection
	...
	hl(0, "Pmenu", { fg = c.base, bg = c.gray1 }) -- Popup menu: normal item.
	hl(0, "PmenuSel", { fg = c.base, bg = c.gray2 }) -- Popup menu: selected item.
	hl(0, "PmenuSbar", { fg = c.base, bg = c.gray1 }) -- Popup menu: scrollbar.
	hl(0, "PmenuThumb", { fg = c.base, bg = c.gray3 }) -- Popup menu: Thumb of the scrollbar.
	...
	hl(0, "Folded", { fg = c.gray2 }) -- line used for closed folds
	...
	hl(0, "FloatBorder", { fg = c.gray3, bg = c.bg })
	hl(0, "QuickFixLine", { bg = c.gray1 }) -- Current |quickfix| item in the quickfix window. Combined with |hl-CursorLine| when the cursor is there.
	hl(0, "qfFileName", { fg = c.base })
	hl(0, "qfLineNr", { fg = c.yellow0 })
	hl(0, "MatchParen", { fg = c.orange2 }) -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
	...
	hl(0, "Substitute", { fg = c.bg, bg = c.gray3 }) -- |:substitute| replacement text highlighting
	hl(0, "Question", { fg = c.yellow0 }) -- |hit-enter| prompt and yes/no questions
	...
	-- Code
	hl(0, "Comment", { fg = c.gray2, italic = true }) -- any comment
	hl(0, "Title", { fg = c.gray5, bold = true }) -- titles for output from ":set all", ":autocmd" etc.
	hl(0, "String", { fg = c.cascade }) --   a string constant: "this is a string"
	hl(0, "Character", { fg = c.gray3 }) --  a character constant: 'c', '\n'
	...
	hl(0, "Define", { fg = c.gray5 }) --   preprocessor #define
	hl(0, "Macro", { fg = c.gray5 }) --    same as Define
	hl(0, "PreCondit", { fg = c.gray5 }) --  preprocessor #if, #else, #endif, etc.
	...
	hl(0, "Label", { fg = c.gray3 }) --    case, default, etc.
	hl(0, "Operator", { fg = c.gray3 }) -- "sizeof", "+", "*", etc.
	...
	hl(0, "Exception", { fg = c.gray3 }) --  try, catch, throw
	...
	hl(0, "Tag", { fg = c.gray3 }) --    you can use CTRL-] on this
	hl(0, "Delimiter", { fg = c.gray3 }) --  character that needs attention
	...
	-- StatusLine
	hl(0, "StatusLine", { fg = c.gray3, bg = c.gray1 }) -- status line of current window
	...
	hl(0, "StatusLineSeparator", { fg = c.gray3 })
	...
	hl(0, "GitSignsChange", { fg = c.orange2 }) -- diff mode: Changed line |diff.txt|
	...
	hl(0, "NvimTreeGitMerge", { fg = c.orange2 })
	...
	-- Null-ls
	hl(0, "NullLsInfoBorder", { fg = c.gray3 })

	-- Markdown
	hl(0, "markdownCode", { fg = c.orange1 })
	hl(0, "markdownCodeBlock", { fg = c.gray1 })
	hl(0, "markdownCodeDelimiter", { fg = c.base })
	hl(0, "markdownBlockquote", { fg = c.orange1 })
	hl(0, "markdownH1", { fg = c.blue2, bold = true })
	hl(0, "markdownH2", { fg = c.blue2, bold = true })
	hl(0, "markdownH3", { fg = c.blue2, bold = true })
	hl(0, "markdownH4", { fg = c.blue2, bold = true })
	hl(0, "markdownH5", { fg = c.blue2, bold = true })
	hl(0, "markdownH6", { fg = c.blue2, bold = true })
	hl(0, "markdownListMarker", { fg = c.blue2 })
	hl(0, "markdownOrderedListMarker", { fg = c.blue2 })
	hl(0, "markdownUrl", { fg = c.base })
	hl(0, "markdownLinkText", { fg = c.orange1, underline = true })
	hl(0, "markdownHeadingDelimiter", { fg = c.blue2 })
	...
	hl(0, "@comment.warning", { fg = c.yellow0 })
	hl(0, "@comment.todo", { fg = c.purple })
	hl(0, "@comment.hint", { fg = c.blue2 })
	hl(0, "@comment.note", { fg = c.blue2 })
	...
	hl(0, "LspReferenceText", { bg = c.gray1 }) -- used for highlighting "text" references
